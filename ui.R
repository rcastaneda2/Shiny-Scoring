...
shinyUI(fluidPage(#theme="bootstrap_flatly.css",
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("v7", 
                  label = "I'm worried about the changes in my physical appearance due to my illness",
                  choices = c("Always", "Often",
                              "Sometimes", "Rarely", "Never","NA"),
                  selected = "Never"),
      
      selectInput("v8", 
                  label = "I feel less like going out or seeing relatives or friends",
                  choices = c("Always", "Often",
                              "Sometimes", "Rarely", "Never","NA"),
                  selected = "Never"),
    ...
    mainPanel(
      tabsetPanel(type="tabs",
                  ...
                  tabPanel("Descriptions",includeHTML("www/summary.html"),icon=icon("navicon",lib="font-awesome")),
